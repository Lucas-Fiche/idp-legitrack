"""Cria tabelas iniciais com base no diagrama

Revision ID: a3ed4e7e3514
Revises: 
Create Date: 2025-11-04 22:42:10.264411
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['id_ultima_situacao'], ['tp_situacao.id_situacao'], ),
    sa.ForeignKeyConstraint(['id_ultima_tramitacao'], ['tp_tramitacao.id_tramitacao'], ),
    ...
    sa.ForeignKeyConstraint(['id_projeto'], ['tb_projeto.id_projeto'], ),
    sa.ForeignKeyConstraint(['id_tema'], ['tp_temas.id_tema'], ),
    ...
    sa.Column('id_tramitacao', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_projeto'], ['tb_projeto.id_projeto'], ),
    sa.ForeignKeyConstraint(['id_situacao'], ['tp_situacao.id_situacao'], ),
    sa.ForeignKeyConstraint(['id_tramitacao'], ['tp_tramitacao.id_tramitacao'], ),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('rl_tramitacoes')
    op.drop_table('rl_temas')
    op.drop_table('tb_projeto')
    op.drop_table('tp_tramitacao')
    op.drop_table('tp_temas')
    op.drop_table('tp_situacao')
    # ### end Alembic commands ###
